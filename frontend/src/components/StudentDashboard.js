...
const StudentDashboard = () => {
  ...
  const fetchStudentInfo = async () => {
    try {
      const res = await axios.get('https://mindscape-ghx1.onrender.com/api/student/info', {
  ...
  const fetchAvailableCourses = async () => {
    setLoading(true);
    try {
      const res = await axios.get('https://mindscape-ghx1.onrender.com/api/student/courses', {
        headers: { authorization: token },
      });
  ...
  const fetchMyCourses = async () => {
    setLoading(true);
    try {
      const res = await axios.get('https://mindscape-ghx1.onrender.com/api/student/my-courses', {
        headers: { authorization: token },
      });
  ...
  const fetchLeaderboard = async () => {
    try {
      const res = await axios.get('https://mindscape-ghx1.onrender.com/api/student/leaderboard', {
        headers: { authorization: token },
      });
  ...
  const fetchEnrollmentRequests = async () => {
    try {
      const res = await axios.get('https://mindscape-ghx1.onrender.com/api/student/enrollment-requests', {
        headers: { authorization: token },
      });
  ...
  const registerCourse = async (courseId) => {
    ...
    try {
      const res = await axios.post(
        'https://mindscape-ghx1.onrender.com/api/student/courses/register',
        { courseId },
        { headers: { authorization: token } }
      );
  ...
  const dropCourse = async (courseId) => {
    ...
    try {
      const res = await axios.post(
        'https://mindscape-ghx1.onrender.com/api/student/courses/drop',
        { courseId },
        { headers: { authorization: token } }
      );
      setMessage(res.data.message);
